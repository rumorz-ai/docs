...
class EntityMetricTransform(Enum):
    """
    Enum representing different types of metric transformations.
    """
    LAST = 'last'
    AVERAGE = 'average'
    TICKS = 'ticks'
...
class EntityMetrics(Enum):
    """
    Enum representing different entity metrics in the Rumorz Graph.
    """
    MENTIONS = 'mentions'
    SENTIMENT = 'sentiment'
...
class TimeHorizon(Enum):
    """
    Enum representing different time horizons.
    """
    SHORT = 'short'
    LONG = 'long'
```
