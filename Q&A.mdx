...
#### Why is every API endpoint a POST request?
...
Rumorz is currently available via API only. Agents will be available soon.

#### How do I get an API Key?
Signup at https://rumorz.io and create a key.
